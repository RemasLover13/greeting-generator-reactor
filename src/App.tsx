...
function App() {
  ...
  useEffect(() => {
    const animeBackgrounds = [
      "https://images.pexels.com/photos/1252890/pexels-photo-1252890.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080",
      "https://images.pexels.com/photos/2101187/pexels-photo-2101187.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080",
      "https://images.pexels.com/photos/207529/pexels-photo-207529.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080",
      "https://images.pexels.com/photos/326055/pexels-photo-326055.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080"
    ];
    
    const randomIndex = Math.floor(Math.random() * animeBackgrounds.length);
    setBackgroundImage(animeBackgrounds[randomIndex]);
  }, []);
  ...
  return (
    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10">
        <header className="text-2xl font-bold p-4 text-center text-white drop-shadow-lg">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl p-6 md:p-8">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full border-2 border-gray-200 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all bg-white/80"
                />
              </div>
              ...
              <div className="mb-6">
                ...
                <select 
                  ...
                  className="w-full border-2 border-gray-200 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all bg-white/80 cursor-pointer"
                >
                  {LANGUAGES.map((lang) => (
            ...
            {(greeting || greetingImage || isGeneratingImage) && (
              <div className="mt-8 space-y-6">
                {greeting && (
                  <div className="p-6 bg-white/90 backdrop-blur-sm rounded-xl shadow-xl border border-gray-200 animate-fadeIn">
                ...
                {isGeneratingImage && !greetingImage && (
                  <div className="p-6 bg-white/90 backdrop-blur-sm rounded-xl shadow-xl border border-gray-200 text-center">
